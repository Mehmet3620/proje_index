(function ($) {
    let $this = $(this),
        ...
        monyNamArr = [
            ...
            '32000 TL KAZANDINIZ',
            '64000 TL KAZANDINIZ',
            '132000 TL KAZANDINIZ',
            '250000 TL KAZANDINIZ',
            '500000 TL KAZANDINIZ',
            '10000000 TL KAZANDINIZ'
        ],
        i,
        j;
    ...
    function money() {
        $('.startup .logo').append('<input type="text" class="name" placeholder="isminiz" /><buttun class="getName">Tamam</buttun></form>');
